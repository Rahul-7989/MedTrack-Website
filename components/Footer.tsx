    ...
    <footer className="px-6 py-20 bg-softIvory border-t border-softAsh/10">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-16">
        <div className="col-span-1 md:col-span-2 space-y-8">
          ...
          <p className="text-mutedSlate max-w-md leading-relaxed text-lg">
        ...
        <div className="space-y-6">
          <h4 className="text-sm font-bold uppercase tracking-widest text-charcoal">Our Promise</h4>
        ...
        <div className="space-y-6">
          <h4 className="text-sm font-bold uppercase tracking-widest text-charcoal">Connect</h4>
          <div className="space-y-4 text-sm text-mutedSlate">
            <p>Need help or have ideas? We're listening:</p>
            <a href="mailto:care@medtrac.app" className="text-mutedTeal hover:underline font-bold text-base">
              care@medtrac.app
            </a>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto mt-20 pt-10 border-t border-softAsh/10 flex flex-col md:flex-row justify-between items-center gap-6 text-sm text-softAsh">
